Feature: Tek School Scenarios
  ...
  Scenario Outline: SDET2019AUG_SDET_003_Execution with multiple user and password
    ...
    |Mac|Dell|sdrssssse@gmail.com|2023457676|Test123|
    ...
    And User sends query 'select * from public.customer where email='megan.palmer@sakilacustomer.orga'
    Then User verify account is created with e mail 'megan.palmer@sakilacustomer.orga'
